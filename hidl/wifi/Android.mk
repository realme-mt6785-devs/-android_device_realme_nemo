...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.nemo.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.nemo.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.nemo
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service.nemo.rc \
    android.hardware.wifi@1.0-service.nemo.xml
